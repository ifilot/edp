...
```
wget -O - http://st-a1960.chem.tue.nl/repos/apt/conf/imc-repo.gpg.key|sudo apt-key add -
```
Add repository

```
echo "deb http://st-a1960.chem.tue.nl/repos/apt/debian/ stretch main" | sudo tee -a /etc/apt/sources.list.d/imc-repo.list
```
